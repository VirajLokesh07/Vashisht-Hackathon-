...
guide_expert = Agent(
    ...
    verbose=True,
    max_iter=5,
    llm=LLM(model="ollama/llava",base_url="http://localhost:11434"),
...
location_expert = Agent(
    ...
    verbose=True,
    max_iter=5,
    llm= LLM(model="ollama/llava",base_url="http://localhost:11434"),   # ChatOpenAI(temperature=0, model="gpt-4o-mini"),
    allow_delegation=False,
)
